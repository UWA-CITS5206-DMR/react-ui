 ...
 */
export function createHeartRatePayload(heartRate: number, patientId: number, userId: number): ObservationCreateBundle {
    return {
        heart_rate: {
 ...
 */
export function createPainScorePayload(score: number, patientId: number, userId: number): ObservationCreateBundle {
    return {
        pain_score: {
            score,
            patient: patientId,
