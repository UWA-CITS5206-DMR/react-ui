...
type AssertInstructorBloodTests = Expect<
  Awaited<
    ReturnType<typeof apiClientV2.instructors.bloodTestRequests.list>
  > extends PaginatedResponse<BloodTestRequest>
    ? true
    : false
>;
...
type AssertObservationBundle = Expect<
  Awaited<
    ReturnType<typeof apiClientV2.studentGroups.observations.createBundle>
  > extends ObservationBundle
    ? true
    : false
>;
...
type _AllAssertions = AssertLogin &
  AssertInstructorBloodTests &
  AssertPatientList &
  AssertObservationBundle &
  AssertQueryParamTyping;
