...
export class ApiClientV2 {
	...
	instructors = {
		...
		bloodTestRequests: {
			...
			partialUpdate: (
				id: number,
				payload: Partial<BloodTestRequestCreate>,
			) =>
				this.request<BloodTestRequest>(
					`/api/instructors/blood-test-requests/${id}/`,
	...
	studentGroups = {
		...
		medicationOrders: {
			list: (query?: QueryParams) =>
				this.request<PaginatedResponse<MedicationOrder>>(
					"/api/student-groups/medication-orders/",
					{ method: "GET", query },
				),
			create: (payload: MedicationOrderCreate) =>
				this.request<MedicationOrder>(
					"/api/student-groups/medication-orders/",
					{ method: "POST", body: payload },
				),
			retrieve: (id: number) =>
		...
		notes: {
			list: (query?: QueryParams) =>
				this.request<PaginatedResponse<NoteEntry>>(
		...
		observations: {
			...
			createBundle: (payload: ObservationCreateBundle) =>
				this.request<ObservationBundle>(
					"/api/student-groups/observations/",
					{ method: "POST", body: payload },
				),
			bloodPressures: {
				...
				partialUpdate: (
					id: number,
					payload: Partial<BloodPressureCreate>,
				) =>
					this.request<BloodPressureRecord>(
						`/api/student-groups/observations/blood-pressures/${id}/`,
						{ method: "PATCH", body: payload },
			...
			bloodSugars: {
				...
				partialUpdate: (
					id: number,
					payload: Partial<BloodSugarCreate>,
				) =>
					this.request<BloodSugarRecord>(
						`/api/student-groups/observations/blood-sugars/${id}/`,
						{ method: "PATCH", body: payload },
			...
			bodyTemperatures: {
				...
				partialUpdate: (
					id: number,
					payload: Partial<BodyTemperatureCreate>,
				) =>
					this.request<BodyTemperatureRecord>(
						`/api/student-groups/observations/body-temperatures/${id}/`,
						{ method: "PATCH", body: payload },
			...
			oxygenSaturations: {
				...
				partialUpdate: (
					id: number,
					payload: Partial<OxygenSaturationCreate>,
				) =>
					this.request<OxygenSaturationRecord>(
						`/api/student-groups/observations/oxygen-saturations/${id}/`,
						{ method: "PATCH", body: payload },
			...
			respiratoryRates: {
				...
				partialUpdate: (
					id: number,
					payload: Partial<RespiratoryRateCreate>,
				) =>
					this.request<RespiratoryRateRecord>(
						`/api/student-groups/observations/respiratory-rates/${id}/`,
						{ method: "PATCH", body: payload },
	...
	patients = {
		list: (query?: QueryParams) =>
			this.request<PaginatedResponse<Patient>>(
		...
		files: {
			list: (patientId: number, query?: QueryParams) =>
				this.request<PaginatedResponse<PatientFile>>(
		...
		uploadFile: (patientId: number, payload: PatientFileUpload) => {
			...
			return this.request<PatientFile>(
				`/api/patients/patients/${patientId}/upload_file/`,
				{ method: "POST", body: formData },
			);
		},
	};
